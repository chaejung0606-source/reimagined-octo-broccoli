...
남은 작업 전체는 [06. 남은 작업](docs/06-backlog.md) 에 정리되어 있습니다.

---

## 개발

이어서 개발할 때는 [CLAUDE.md](CLAUDE.md) 를 먼저 읽으세요. 브랜치 규칙,
규칙 추가 방법, 지켜야 할 경계(개인정보·배포본 분리·윈도우 배치파일 인코딩)가
정리되어 있습니다.
...
푸시하면 GitHub Actions 가 위 두 가지와 문법 검사, 서류 파일 혼입 검사를 돌립니다.
